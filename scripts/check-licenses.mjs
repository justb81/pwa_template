...
//
// This project ships under Apache-2.0 and must only redistribute dependencies
// under OSI-approved, permissive licenses (see docs/architecture.md §2). This script
